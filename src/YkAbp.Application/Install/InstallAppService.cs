...
namespace YkAbp.Application.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : YkAbpAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<YkAbpDbContext> _migrator;
        ...
        public async Task Setup(InstallDto input)
        {
            ...
            if (CheckDatabaseInternal())
            {
                ...
                SeUrl(input.WebSiteUrl, input.ServerUrl);
        ...
        private void SeUrl(string webSitRUrl, string serverUrl)
        {
