...
using YkAbp.Application.DemoUiComponents.Dto;
using YkAbp.Core.Authorization;

namespace YkAbp.Application.DemoUiComponents
{
    [AbpAuthorize(PermissionNames.DemoUiComponents)]
    public class DemoUiComponentsAppService : YkAbpAppServiceBase, IDemoUiComponentsAppService
    {
