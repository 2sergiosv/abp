...
using YkAbp.Application.IO;
using YkAbp.Application.Logging.Dto;
using YkAbp.Application.Net.MimeTypes;
using YkAbp.Core;
...
namespace YkAbp.Application.Logging
{
    ...
    public class WebLogAppService : YkAbpAppServiceBase, IWebLogAppService
    {
        ...
        public GetLatestWebLogsOutput GetLatestWebLogs()
        {
            ...
            var lastLogFile = directory.GetFiles("*.log", SearchOption.AllDirectories)
