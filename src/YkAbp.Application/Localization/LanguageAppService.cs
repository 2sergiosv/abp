...
using Abp.UI;
using YkAbp.Application.Localization.Dto;
using YkAbp.Core.Authorization;
using YkAbp.Core.Localization;

namespace YkAbp.Application.Localization
{
    [AbpAuthorize(PermissionNames.Administration_Languages)]
    public class LanguageAppService : YkAbpAppServiceBase, ILanguageAppService
    {
        ...
        [AbpAuthorize(PermissionNames.Administration_Languages_Create, PermissionNames.Administration_Languages_Edit)]
        ...
        [AbpAuthorize(PermissionNames.Administration_Languages_ChangeTexts)]
        ...
        [AbpAuthorize(PermissionNames.Administration_Languages_Create)]
        ...
        [AbpAuthorize(PermissionNames.Administration_Languages_Edit)]
