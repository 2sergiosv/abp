...
using YkAbp.Application.Authorization.Roles.Dto;
using YkAbp.Core.Authorization;
using YkAbp.Core.Authorization.Roles;

namespace YkAbp.Application.Authorization.Roles
{
    /// <summary>
    /// Application service that is used by 'role management' page.
    /// </summary>
    [AbpAuthorize(PermissionNames.Administration_Roles)]
    public class RoleAppService : YkAbpAppServiceBase, IRoleAppService
    {
