...
using YkAbp.Application.Authorization.Permissions;
using YkAbp.Application.Authorization.Permissions.Dto;
using YkAbp.Application.Authorization.Users.Dto;
using YkAbp.Application.Authorization.Users.Exporting;
using YkAbp.Application.Dto;
using YkAbp.Application.Organizations.Dto;
...
namespace YkAbp.Application.Authorization.Users
{
    ...
    public class UserAppService : YkAbpAppServiceBase, IUserAppService
    {
        ...
        [AbpAuthorize(PermissionNames.Administration_Users_Create, PermissionNames.Administration_Users_Edit)]
        ...
        [AbpAuthorize(PermissionNames.Administration_Users_ChangePermissions)]
        ...
        [AbpAuthorize(PermissionNames.Administration_Users_Delete)]
