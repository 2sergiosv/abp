...
using YkAbp.Application.Authorization.Users.Profile.Cache;
...
{
    [AbpAuthorize]
    public class ProfileAppService : YkAbpAppServiceBase, IProfileAppService
    {
