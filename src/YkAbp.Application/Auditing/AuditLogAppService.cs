...
using YkAbp.Application.Auditing.Exporting;
...
{
    [DisableAuditing]
    [AbpAuthorize(PermissionNames.Administration_AuditLogs)]
    public class AuditLogAppService : YkAbpAppServiceBase, IAuditLogAppService
    {
